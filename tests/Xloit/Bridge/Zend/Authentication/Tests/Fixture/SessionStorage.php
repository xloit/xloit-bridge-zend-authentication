...
class SessionStorage extends Storage\Session
{
    ...
    {
        return !isset($this->storage[$this->member]);
    }
    ...
    {
        return $this->storage[$this->member];
    }
    ...
    {
        $this->storage[$this->member] = $contents;
    }
    ...
    {
        unset($this->storage[$this->member]);
    }
}
